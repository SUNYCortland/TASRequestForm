    ...
    public class AuthController : Controller
    {
        ...
        public ActionResult Login(string ticket, string ReturnUrl)
        {
            ...
            if (!String.IsNullOrEmpty(strNetId))
            {
                ...
                Response.Cookies.Add(GetFormsAuthenticationCookie(bannerUser, _administratorService.IsAdministratorByPidm(bannerUser.Pidm)));
            }
            else
            {
                return HttpNotFound();
        ...
        private HttpCookie GetFormsAuthenticationCookie(BannerIdentity identity, bool isAdmin)
        {
